...
SECRET_KEY = 'django-insecure-u8k4&v5!al&oazn13n2!xl!k!y)7^_-!42f%v(k$)mlxvl)fxa'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'portfolio', 'templates')],# 👈 Aquí le dices dónde está tu carpeta templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
